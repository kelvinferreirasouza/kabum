            ...
            <div class="col-xs-12 col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title line-height-default">Perguntas Frequentes</h3>
                                ...
                                <form action="<?= URL . $this->dir  ?>" method="GET">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Ex: pagamento" name="buscar" value="<?= (isset($_GET['buscar']) ? $_GET['buscar'] : ''); ?>">
                                        </div>
                                    </div>
                    ...
                    <div class="box-body">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                            ...
                                            <?php if ($obj->ativo == 1) : ?>
                                                ...
                                                <td>
                                                    <div class="text-center">
                                                        <a class="btn-circle btn-primary" href="<?= URL . $this->controller . "/expandir/" . $obj->id ?>"><i class="fa fa-pencil"></i></a>
                                                        <a class="btn-circle btn-danger btn-desativar-pergunta" id="<?= $obj->id ?>"><i class="fa fa-times"></i></a>
                                                    </div>
                                                </td>
                                            <?php else : ?>
                                                <td class="text-center">
                                                ...
                                                <td>
                                                    <div class="text-center">
                                                        <a class="btn-circle btn-primary" href="<?= URL . $this->controller . "/expandir/" . $obj->id ?>"><i class="fa fa-pencil"></i></a>
                                                        <a class="btn-circle btn-success btn-ativar-pergunta" id="<?= $obj->id ?>"><i class="fa fa-check"></i></a>
                                                    </div>
                                                </td>
                                            <?php endif ?>
                                        </tr>
                                ...
                                <?php } else { ?>
                                    <tr>
                                        <td class="text-center" colspan="7">Nenhuma pergunta cadastrado.</td>
                                    </tr>
                                <?php } ?>

                                <div id="desativa-pergunta" class="modal fade" tabindex="-1" role="dialog">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Deseja realmente desativar esta pergunta?
                                            </div>
                                ...
                                <div id="ativa-pergunta" class="modal fade" tabindex="-1" role="dialog">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            ...
                                            <div class="modal-body">
                                                Deseja realmente ativar esta pergunta?
                                            </div>
