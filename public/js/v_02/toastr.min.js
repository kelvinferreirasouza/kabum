...
function toastError(msg = 'Ocorreu algum erro!') {
    toastr.error(msg, '', {
        "closeButton": true,
        "debug": false,
        "newestOnTop": false,
...
function toastWarningNoDuplicate(msg = 'Ação realizada com sucesso!') {
    toastr.warning(msg, '', {
        "closeButton": true,
        "debug": false,
        "newestOnTop": false,
...
function toastDangerNoDuplicate(msg = 'Ação realizada com sucesso!') {
    toastr.error(msg, '', {
        "closeButton": true,
        "debug": false,
        "newestOnTop": false,
